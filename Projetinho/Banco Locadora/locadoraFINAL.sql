...
create table Logins(
    ...
    on delete cascade,
    constraint fk_UserFunc foreign key (id_funcionario) references Funcionarios (id_funcionario)
    on delete cascade
);
...
insert into Logins (id_cliente, id_funcionario, email, senha, tipo_usuario, logOn) values (
...
insert into Reservas (id_cliente, veiculo, id_tipo, data_retirada, data_devolucao, id_loja) values
(1, "ASC-4568", 1, "2021-11-22 13:30:15", "2021-11-27 17:30:40", 1); 
